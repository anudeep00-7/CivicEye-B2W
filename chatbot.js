...
Focus on high-vote issues for maximum impact!`,
    ...
    civiceye: `About CivicEye:
CivicEye is a civic-tech platform that connects citizens with NGOs to resolve community issues.

Key Features:
• Report civic issues with photos and location
• Vote on issues to prioritize them
• Track progress from submission to resolution
• Connect with local NGOs who can help

Together, we make communities better!`,

    hello: `Hello! Welcome to CivicEye! 👋

I'm your Civic Assistant, here to help you:
• Report civic issues in your community
• Understand how CivicEye works
• Choose the right category for your report
...
function getFallbackResponse(message) {
    ...
    // About CivicEye
    if (lower.includes('civiceye') || lower.includes('civic eye') || lower.includes('what is') || lower.includes('about') || lower.includes('platform') || lower.includes('app')) {
        return FALLBACK_RESPONSES.civiceye;
    }
    if (lower.includes('report') || lower.includes('submit') || lower.includes('create') || lower.includes('issue') || lower.includes('problem')) {
    ...
    if (lower.includes('resolution') || lower.includes('resolve') || lower.includes('status') || lower.includes('time') || lower.includes('long') || lower.includes('how long')) {
